    ...
    <div id="content-wrapper" class="d-flex flex-column"> 
        ...
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" id="navbar-color">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <h1>Consultar Reservas Individuais Cadastradas</h1>
            <table class="table">
                <thead>
                    <tr>
                        <td scope="col"><strong>ID</strong></td>	
                        <td scope="col"><strong>Nome</strong></td>		
                        <td scope="col"><strong>Data e Hora</strong></td>
                    ...
                    <?php
                        ...
                        $selecionar= mysqli_query($conn, "SELECT * FROM tb_reserva_individual");
                        while ($campo= mysqli_fetch_array($selecionar)){?>
                            <tr>
                                <th scope="row"><?=$campo["id_reserva_individual"]?></th>
                                <th scope="row"><?=$campo["nome_cliente"]?></th>
                                <th scope="row"><?=$campo["data_hora"]?></th>
                                <th scope="row"><?=$campo["taxa"]?></th>
                                <th scope="row"><?=$campo["descricao"]?></th>
                                <th scope="row"><a href="FormEditarReserva_Individual.php?editarid=<?php echo $campo ['id_reserva_individual'];?>">Editar</a></th>
                                <th scope="row"><i><a href="ExcluirReserva?p=excluir&reserva_individual=<?php echo $campo['id_reserva_individual'];?>">Excluir</i></a></th>
                            </tr>
                    <?php }?>
                </table>
    </body>
