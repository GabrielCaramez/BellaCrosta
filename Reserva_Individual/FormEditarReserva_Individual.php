    ...
    <body class="formCadastrarCliente">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                $selecionar = mysqli_query($conn, "SELECT * FROM tb_reserva_individual WHERE id_reserva_individual=$recid");
                                        ...
                                        <div class="col-lg-6">
                                            <div class="p-5">
                                                <div class="text-center">
                                                    <h1 class="h4 text-gray-900 mb-4">Editar Dados da Reserva Individual</h1>
                                                </div>
                                                <form class="user" action="EditarReserva_Individual.php" method="post">
                                                    <!--esta linha cria um campo oculto para passar o id_cidade, pois senão ao clicar em Salvar o código não saberá onde salvar.-->
                                                    <input type="hidden" name="id" value="<?= $campo["id_reserva_individual"] ?>">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user" id="exampleInputCpf"
                                                               name="data_hora" placeholder="Digite a data e hora" value="<?= $campo["data_hora"] ?>">
                                                    </div>
