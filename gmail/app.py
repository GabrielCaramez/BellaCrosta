...
def index():
    if request.method == 'POST':
        ...
        print(f"Tentando enviar email para: {email_destinatario}")
        ...
        if sucesso:
            ...
            <div style="
                ...
                box-shadow: 0 4px 16px rgba(255, 78, 80, 0.10);
            ">
                <b>Falha ao enviar email.</b><br>
                <span style="color:red;">Verifique se o email é válido e se o servidor está configurado corretamente.</span>
            </div>
            '''
